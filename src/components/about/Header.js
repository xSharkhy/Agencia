	...
	return (
		<main>
			<div className="relative px-6 lg:px-8">
				<div className="max-w-full pt-24 pb-12 mx-auto xl:mx-12 xl:pt-32 xl:pb-40 lg:pt-40 lg:pb-40 ">
					<div>
						<div>
							<h1 className="pb-8 text-4xl font-semibold tracking-tight sm:text-7xl">
								About us
							</h1>
							<p className="max-w-5xl mt-6 text-2xl leading-10 text-black">
